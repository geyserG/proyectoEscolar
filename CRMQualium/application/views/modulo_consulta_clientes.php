<div id="posicion_infotd">
      <table id="tbla_cliente" class="table table-striped">      
            ...
            <tr>
                ...
                <td><img class="logo_empresa" src="img/fotosClientes/cliente3.jpg" alt="" class="img-thumbnail"></td>
            ...
            <tr>
                ...
                <td><img class="logo_empresa" src="img/fotosClientes/cliente4.png" alt="" class="img-thumbnail"></td>
                <td>Apple </td>
                <td>@gmail</td>
                <td>Steve Jobs</td>
                <td>04/06/2014</td>
             ...
             <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" src="img/fotosClientes/fb.png" alt="" class="img-thumbnail"></td>
                <td>Facebook</td>
                <td>@hotmail</td>
             ...
             <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" src="img/fotosClientes/youtube.jpg" alt="" class="img-thumbnail"></td>
                <td>youtube</td>
                <td>@hotmail</td>
                <td>Steven Chan</td>
                <td>04/06/2014</td>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" src="img/fotosClientes/tw.png" alt="" class="img-thumbnail"></td>
                <td>Twitter</td>
                <td>@yahoo.mx</td>
                <td>Evan Williams</td>
                <td>04/06/2014</td>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" src="img/fotosClientes/coliseo.jpg" alt=""></td>
                <td>Coliseo Yucatán</td>
                <td>@yahoo.mx@hotmail.com</td>           
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" class="logo_empresa" src="img/fotosClientes/ford.png" alt="" class="img-thumbnail"></td>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" class="logo_empresa" src="img/fotosClientes/google.jpg" alt="" class="img-thumbnail"></td>
                <td>Google</td>
                <td>@hotmail.com</td>
                <td>Larry Page</td>
                <td>04/06/2014</td>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" src="img/fotosClientes/mozilla.jpg" alt="" class="img-thumbnail"></td>
                <td>@firefox.mx</td>
                <td>Comunicacion</td>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td><img class="logo_empresa" src="img/fotosClientes/che.jpg" alt="" class="img-thumbnail"></td>
                <td>Chevrolet</td>
                <td>@gmail.com</td>
                  ...
                  <ul id="menu2-lista">
                    <li class="">
                      <label class="icono2" for="3">
                         <span href="#div1"  class="MO icon-friends"  data-toggle="tooltip" data-placement="right" title="Contactos">
                         </span>
                      </label>
                   </li>
                   <li class="">
                      <label class="icono2" for="4">
                        <span  href="#div2" class="MO icon-user"  data-toggle="tooltip" data-placement="right" title="Representate">
                        </span> 
                     </label>
                   </li>
                   <li class="">
                      <label class="icono2" for="1"><span class="icon-trash"   data-toggle="tooltip" data-placement="right" title="Eliminar"></span>
                      </label>
                   </li>
                   <li class="">
                      <label class="icono2" for="2"><span class="icon-edit2"  data-toggle="tooltip" data-placement="right" title="Editar"></span>
                      </label>
                  </li>
                  <li class="">
                      <label class="icono2" for="2"><span class="icon-email"  data-toggle="tooltip" data-placement="right" title="Enviar"></span>
                      </label>
                  </li>
               </ul>
            </nav> -->
